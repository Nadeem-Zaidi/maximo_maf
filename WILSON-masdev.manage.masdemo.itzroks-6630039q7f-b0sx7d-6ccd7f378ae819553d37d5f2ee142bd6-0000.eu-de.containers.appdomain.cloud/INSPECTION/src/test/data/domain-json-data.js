...
let domainitem = {
  member: [
    ...
    },
    {
      ...
      description: 'Pending',
      href:
        'oslc/os/mxapisynonymdomain/_SU5TUFJFU1VMVFNUQVRVUy9QRU5ESU5HL35OVUxMfi9_TlVMTH4vUEVORElORw--',
      value: 'PENDING',
      domainid: 'INSPRESULTSTATUS'
    },
    {
  ...
  responseInfo: {
    ...
    totalPages: 1,
    href:
      'oslc/os/mxapisynonymdomain?oslc.select=value%2Cmaxvalue%2Cdescription%2Cdomainid%2Cvalueid%2Csiteid%2Corgid%2Cdefaults&oslc.pageSize=40&oslc.where=domainid%20in%20%5B%22INSPRESULTSTATUS%22%5D%20and%20domainid%3D%22INSPRESULTSTATUS%22&searchAttributes=maxvalue%2Cdomainid%2Cvalueid%2Csiteid%2Corgid&collectioncount=1&ignorecollectionref=1&relativeuri=1&addschema=1&lean=1&internalvalues=1',
    totalCount: 4,
    pagenum: 1
  }
};
